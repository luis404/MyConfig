...
(let ((class '((class color) (min-colors 89)))
      ...
      (ol4 '(:height 1.0 :weight bold :slant normal :foreground "#222222"))
  ...
  (custom-theme-set-faces
   ...
   `(org-done ((,class (:weight bold :box (:line-width 1 :color "#BBBBBB") :foreground "#2B9E2D" :background "#F0F0F0"))))
   ...
   `(org-todo ((,class (:weight bold :box (:line-width 1 :color "#D8ABA7") :foreground "#EE3713" :background "#FFE6E4"))))
